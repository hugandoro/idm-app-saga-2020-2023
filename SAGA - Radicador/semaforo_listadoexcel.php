...
echo "<TR><TD colspan='2'><B>Informe</B></TD><TD colspan='6'>Radicador de Correspondencia Entrante</TD></TR>";
echo "<TR><TD colspan='2'><B>Rango del Informe</B></TD><TD colspan='6'>XXXXX</TD></TR>";
...
while ($rowF = mysqli_fetch_row($resultF))
{
		...
		if ($imprimir == 1)
		{
		  ...
		  echo "<TD align='left'><span class='Texto1'></span></TD>";
		  echo "<TD align='left'><span class='Texto1'></span></TD>";
		  echo "</TR>";
		}
}
